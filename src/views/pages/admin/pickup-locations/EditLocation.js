...
import { createStation, getStation, updateStation } from 'src/helpers/stationHelper'
...
const EditLocation = () => {
  ...
  const onSubmit = async data => {
    ...
    try {
      let response = await updateStation({ name: data.name, details: data.details, status: data.status }, id)
